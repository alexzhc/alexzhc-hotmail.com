...
1. ReadWriteMany
    ...
    Export block volume by host NFS server and use kubernetes cluster ip as the NFS VIP. Workflow is demonstrated by the child project: https://github.com/alexzhc/volume-nfs-provisioner
